...
public class Task_Main {
    public static void main(String[] args) {
        ...
        Set<Task> missingTasks = getSetDiff(everyTask,tasks);
        sortAndPrint("Missing Tasks" , missingTasks);

        Set<Task> unassignedTasks = getSetDiff(tasks , assignedTasks);
    ...
    private static Set<Task> getSetDiff(Set<Task> a , Set<Task>b){
        Set<Task> setDiff = new HashSet<>(a);
        setDiff.removeAll(b);
        return setDiff;
    }
